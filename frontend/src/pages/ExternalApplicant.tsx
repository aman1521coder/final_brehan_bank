...
const ExternalApplicant: React.FC = () => {
    ...
    const fetchJobDetails = async () => {
      try {
        ...
        setJob({
          ...
          requirements: 'Minimum 5 years experience in banking operations. Bachelor\'s degree in Finance or related field.',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await applicationAPI.submitExternal(applicationData, resumeFile || undefined);
  ...
  return (
    <div className="applicant-container">
      <header className="applicant-header">
        <div className="applicant-logo"></div>
        <h1>Berhan Bank External Job Application</h1>
      </header>
      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} className="application-form">
          <h2>External Application Form</h2>
          ...
          <div className="form-group">
            ...
            <input
              ...
              id="education"
              name="education"
              placeholder="e.g., BSc in Finance, MBA"
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="currentCompany">Current/Previous Company</label>
              <input
                type="text"
                id="currentCompany"
                name="currentCompany"
            ...
            <div className="form-group">
              <label htmlFor="currentPosition">Current/Previous Position</label>
              <input
                type="text"
                id="currentPosition"
          ...
          <div className="form-group">
            <label htmlFor="resume">Upload Your Resume (PDF or Word)<span className="required">*</span></label>
            <input
              type="file"
              id="resume"
              name="resume"
